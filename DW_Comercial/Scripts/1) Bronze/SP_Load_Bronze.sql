...
BEGIN
    ...
    BEGIN TRY
        ...
        PRINT ('');
        PRINT ('-----------------------------------');
        ALTER TABLE bronze.ventas DROP COLUMN IF EXISTS dwh_fecha_carga;
        ...
        ALTER TABLE bronze.ventas ADD dwh_fecha_carga DATETIME2;
        EXEC('UPDATE bronze.ventas SET dwh_fecha_carga = GETDATE();');
